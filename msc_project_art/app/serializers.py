...
from .models import (
    ExcelFile, ShiftManager, AreaForeman, Employee, 
    ShiftManagerHistory, AreaForemanHistory, EmployeeHistory,
    Artactividad, Actividad, Peligro, Riesgo, MedidaControl, Area
)
...
class AreaForemanSerializer(serializers.ModelSerializer):
    class Meta:
        model = AreaForeman
        fields = '__all__'
