...
""" from app.views import ExcelFileListCreateView, ExcelFileDetailView """
from rest_framework.decorators import action
from django.shortcuts import get_object_or_404
from rest_framework.viewsets import ModelViewSet
from .models import (  ExcelFile, ShiftManager, AreaForeman, Employee, Area, Artactividad, Actividad, Peligro, Riesgo, MedidaControl)
from .serializers import (
    ExcelFileSerializer, ShiftManagerSerializer, AreaForemanSerializer, 
    EmployeeSerializer, ArtactividadSerializer, ActividadSerializer, AreaSerializer , PeligroSerializer, RiesgoSerializer, MedidaControlSerializer, ActividadSerializer, PeligroSerializer, RiesgoSerializer, MedidaControlSerializer)
...
class ShiftManagerViewSet(viewsets.ModelViewSet):
    queryset = ShiftManager.objects.all()
    serializer_class = ShiftManagerSerializer

class AreaForemanViewSet(viewsets.ModelViewSet):
    queryset = AreaForeman.objects.all()
    serializer_class = AreaForemanSerializer
