...
from .views import (ShiftManagerViewSet, AreaForemanViewSet, EmployeeViewSet, ExcelFileViewSet,ArtactividadViewSet, ActividadViewSet, PeligroViewSet, RiesgoViewSet, MedidaControlViewSet)

router = DefaultRouter()
router.register(r'shift-managers', ShiftManagerViewSet, basename='shift-manager')
router.register(r'area-foremen', AreaForemanViewSet, basename='area-foreman')
